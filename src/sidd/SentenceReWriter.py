...
LexicalPPDict = pickle.load( open( "../ppdb/"+file_size+"-lexical.pk1", "rb" ) )
#print LexicalPPDict
...
PhrasalPPDict=pickle.load( open( "../ppdb/"+file_size+"-phrasal.pk1", "rb" ) )
...
#         continue
    ...
    #sentence='Antivirals are most useful if given within 48 hours of the start of symptoms and may improve outcomes in hospitalised patients.'
